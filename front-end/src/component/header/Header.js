...
const Header=()=>{
  ...
  return(
    ...
    <div className="container pt-5" style={{width: "100%", minHeight: "80%"}}>
        <section className="sec">
            <div className="px-3 pt-5">
                <div className="row">

                    <div className="col-md-6 godown">
                        <svg xmlns="http://www.w3.org/2000/svg" id="ku" width="90%" baseProfile="tiny" className="svgmate" version="1" viewBox="300 150 550 570">
                ...
                <g id="Woman__x2F__Chair__x2F__Screen">
                  ...
                  <g id="Chair_1_">
                    ...
                    <g id="seat_1_">
                      ...
                      <path id="womanshdow" fill="#413C69"
                  ...
                  <g id="womanscreen" className="womscreenmove">
                  </g>
                  <g id="Woman">
                    <g id="Front_leg">
                    ...
                    <g id="womanhead">
                      ...
                      <g id="hairbase">
                        <path id="tophairmain" fill="#585268"
                ...
                <g id="Man__x2F__chair__x2F__screen">
                    ...
                    <g id="man-body">
                      ...
                      <g id="head">
                        ...
                        <g id="hair">
                          ...
                          <path fill="#585268" d="M399 272c4-1 10-1 14-8s7-19 2-22-1 9-17 8c-27-1-3 23 1 22z" className="mankauf"></path>
                        </g>
                      </g>
                      <g id="torso">
                        
                        <path id="shirt" fill="#c4c1f7"
                      ...
                      <g id="arm">
                        ...
                        <path id="toparmshade" fill="#c2bff5"
                  ...
                  <g id="Man_screen">
                    ...
                    <div className="heading" data-aos="fade-down">
                        <h2 className="main-heading mb-0 projects_head"><span className="my_projects">BlogScope</span></h2>
                    </div>
                </div>
            </div>
        </section>
